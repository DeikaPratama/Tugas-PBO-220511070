...
class FormLogin:
    ...
    def aturKomponen(self):
        ...
        # Label
        Label(mainFrame, text='Email:', justify=tk.CENTER).grid(row=2, column=0, sticky=tk.W, padx=5, pady=5)
        self.txtEmail = Entry(mainFrame) 
        self.txtEmail.grid(row=2, column=1, padx=5, pady=5) 

        Label(mainFrame, text='Password:', justify=tk.CENTER).grid(row=3, column=0, sticky=tk.W, padx=5, pady=5)
        self.txtPassword = Entry(mainFrame) 
        self.txtPassword.grid(row=3, column=1, padx=5, pady=5) 
