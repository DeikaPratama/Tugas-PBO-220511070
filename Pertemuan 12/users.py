...
B = A.Validasi('deikapratama@umc.ac.id','pratama454')
print(B)

print("\n\nUsername BENAR, dan password SALAH")
C = A.Validasi('deikapratama@umc.ac.id','pratama4545')
print(C)

print("\n\nUsername SALAH, dan password BENAR")
D = A.Validasi('faisalsurya@gmail.com','faisalsurya')
print(D)

print("\n\nUsername SALAH, dan password SALAH")
E = A.Validasi('faisalsurya@gmail.com','faisalsurya1')
print(E)
print("\n\n")